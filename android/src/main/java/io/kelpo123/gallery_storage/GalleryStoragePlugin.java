package io.kelpo123.gallery_storage;
...
/** photostorage */
public class GalleryStoragePlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "gallery_storage");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
   if (call.method.equals("getPlatformVersion")) {
    ...
    } else if (call.method.equals("getImagesPath")) {
